...
// ---------------------------
// Modern Flash replacement
// ---------------------------
// Automatically load the Ruffle Flash emulator (https://ruffle.rs)
// so that legacy .swf movies embedded on the site continue to work
// in browsers where the Flash plug‑in is no longer available.
// The script is tiny (<50 KB gzipped) and loads from a free CDN.
// If Ruffle is already present, this block does nothing.
(function addRuffle() {
    if (window.RufflePlayer) return; // already loaded
